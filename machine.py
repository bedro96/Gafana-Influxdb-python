...
class Machine(object):
    ...
    def influxdbInsertData(self, server_info):
        ...
        for data in dict(network.items()):
            fields_data[data] = network[data]
        for data in dict(disk.items()):
            fields_data[data] = disk[data]
...
if __name__ == '__main__':
    ...
    while True:
        server_info = {
            ...
            "network": machinemonitor.network_information(),
            "disk": machinemonitor.disk_information()
        }
